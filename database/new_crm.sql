...
(1, 'User Successfully Logged In [User Id: 1, Is Staff Member: Yes, IP: ::1]', '2025-01-02 15:58:18', 'Purvi  Lad'),
(2, 'New Client Created [ID: 1, From Staff: 1]', '2025-01-02 17:08:55', 'Purvi  Lad'),
(3, 'User Successfully Logged In [User Id: 1, Is Staff Member: Yes, IP: ::1]', '2025-01-03 09:44:06', 'Purvi  Lad'),
(4, 'User Successfully Logged In [User Id: 1, Is Staff Member: Yes, IP: ::1]', '2025-01-03 09:44:25', 'Purvi  Lad');
...
(1, 'Gauraj Infotech Pvt Ltd', '', '97221 04104', 102, 'Vadodara', '390007', 'Gujarat ', '804, K10 GRAND, B/H ATLANTIS K10 SARABHAI CAMPUS, Alkapuri Rd, Vadodara, Gujarat 390007', '', '2025-01-02 17:08:55', 1, NULL, '', '', '', '', 0, '', '', '', '', 0, NULL, NULL, 'english', 1, 0, NULL, 1, 1);
...
--
-- Table structure for table `tblcustomer_visit`
--

DROP TABLE IF EXISTS `tblcustomer_visit`;
CREATE TABLE IF NOT EXISTS `tblcustomer_visit` (
  `id` int NOT NULL AUTO_INCREMENT,
  `visit_planner_id` int NOT NULL,
  ...
  `rel_type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `leadid` int NOT NULL,
  `clientid` int NOT NULL,
  `contacts` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `product_explain` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `p_other` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `opportunity` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `o_other` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tags` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nxt_followup_date` datetime NOT NULL,
  `show_inquiry_form` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `end_product` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `month_prod` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `total_no_of_panels` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `sintering_panel` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kw_rating_sp` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `frequency` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `asbestos` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `maximum_tapping_temperature` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_a` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_e` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `average_tapping_temperature` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_b` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_f` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `avg_power_consumption` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_c` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_g` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `grades_of_steel_produce` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_d` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `diagram_h` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `present_lining_method` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `planner_type_of_scrap` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `charge_mix_ratio` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `cpc` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `met_cock_or_cock_fines` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `slag_generation` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `sintering_time` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `power_consumption_for_sintering_heat` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `c_at_50_of_bath_metal` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `dri_quality` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `c_at_80_of_bath_metal` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `fem_of_dri` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `final_c_before_tap` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `fet_of_dri` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `mill_scale` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `feo_of_dri` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `operation` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `specific_problem_customer_face` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reason_for_lining_breaking` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `specific_erosion_pattern` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `customer_expectation` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tblcustomer_visit`
--

INSERT INTO `tblcustomer_visit` (`id`, `visit_planner_id`, `subject`, `type`, `datetime`, `rel_type`, `leadid`, `clientid`, `contacts`, `product_explain`, `p_other`, `opportunity`, `o_other`, `tags`, `nxt_followup_date`, `show_inquiry_form`, `end_product`, `month_prod`, `total_no_of_panels`, `sintering_panel`, `kw_rating_sp`, `frequency`, `asbestos`, `maximum_tapping_temperature`, `diagram_a`, `diagram_e`, `average_tapping_temperature`, `diagram_b`, `diagram_f`, `avg_power_consumption`, `diagram_c`, `diagram_g`, `grades_of_steel_produce`, `diagram_d`, `diagram_h`, `present_lining_method`, `planner_type_of_scrap`, `charge_mix_ratio`, `cpc`, `met_cock_or_cock_fines`, `slag_generation`, `sintering_time`, `power_consumption_for_sintering_heat`, `c_at_50_of_bath_metal`, `dri_quality`, `c_at_80_of_bath_metal`, `fem_of_dri`, `final_c_before_tap`, `fet_of_dri`, `mill_scale`, `feo_of_dri`, `operation`, `specific_problem_customer_face`, `reason_for_lining_breaking`, `specific_erosion_pattern`, `customer_expectation`) VALUES
(1, 1, 'Test', 'Planned Visit', '2024-12-07 11:19:00', 'Customer', 0, 3, '1', 'Pre-mix Boric', '', 'Nali Top', '', '', '2024-12-12 17:29:00', 'no', '', '', '', 'yes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `tblcustomer_visit_attachment`
--

DROP TABLE IF EXISTS `tblcustomer_visit_attachment`;
CREATE TABLE IF NOT EXISTS `tblcustomer_visit_attachment` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tblcustomer_visit_inquiry`
--

DROP TABLE IF EXISTS `tblcustomer_visit_inquiry`;
CREATE TABLE IF NOT EXISTS `tblcustomer_visit_inquiry` (
  `id` int NOT NULL AUTO_INCREMENT,
  `customer_visit_id` int NOT NULL,
  `furnace_capacity` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kw_rating` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Furnace_oem` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `tap_to_tap_time` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `present_lining_material` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `supplier` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `consumtion_for_new_lining` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `consumption_for_side` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `new_lining_life` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `side_lining_life` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `total_no_of_side_lining` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `total_no_of_heats` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 1, 1, '60000.00', 0, 0, '', '', 'Purchase Expense', 2, 0, 0, NULL, '1', '2024-03-19', NULL, 0, 0, 0, 0, 0, NULL, 0, 0, NULL, '2024-03-19 18:35:56', 1),
(2, 2, 1, '50.00', 0, 0, '', '', 'test expense', 4, 1, 0, NULL, '2', '2024-10-04', NULL, 0, 0, 0, 0, 0, NULL, 0, 0, NULL, '2024-10-04 16:56:41', 1);
...
(311, 'identification_key', '992299599173581369967766a435e865', 1),
...
('002g281lhkq6q72p32hgjusrv92rat9k', '::1', 1735879405, ),
('0gf24gge0tpc9517ad1t70otije9t29a', '::1', 1735816972, ),
('b0drjv1l9aiqlmm3egtuo788gda5kgoo', '::1', 1735817839, ),
('cmjkj573h4rkvudt9hefm0ieu2rcc5h4', '::1', 1735817299, ),
('k0ajkdh3gjn6a18p8s65hr747u046o4r', '::1', 1735879402, ),
('lmfugm768djrktv1sh996ftuuna1q85j', '::1', 1735816656, ),
('mg6ib7jgne8sq6vpu3geqlojh0dlrovg', '::1', 1735818142, ),
('qip9364qsn0a4fs8l355nodmrn13c98k', '::1', 1735877658, 0x5f5f63695f6c6173745f726567656e65726174657c693a313733353837373635383b5f707265765f75726c7c733a34373a22687474703a2f2f6c6f63616c686f73742f616d617a655f63726d2f61646d696e2f61757468656e7469636174696f6e223b),
('sh66td4re7ddnddtiqdnq9empfqre18s', '::1', 1735818146, );
...
(1, 'n.r.soni1@gmail.com', 'Purvi ', 'Lad', NULL, NULL, NULL, NULL, '$2a$08$CvRE7.K7L7AjFFHiQ3mGr.LEgfAiXGv6d1IxWBrtOVUL7CwPVAuaO', '2025-01-02 10:27:48', NULL, '::1', '2025-01-03 09:44:25', '2025-01-03 10:13:25', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL, NULL, 0, '0.00', 0, NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `tblvisit_planner`
--

DROP TABLE IF EXISTS `tblvisit_planner`;
CREATE TABLE IF NOT EXISTS `tblvisit_planner` (
  `id` int NOT NULL AUTO_INCREMENT,
  `subject` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `datetime` datetime NOT NULL,
  ...
  `visit_planner_company_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_to` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_gstno` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_address` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_city` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_state` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_country` int NOT NULL,
  `visit_planner_zip` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `visit_planner_phone` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tblvisit_planner`
--

INSERT INTO `tblvisit_planner` (`id`, `subject`, `type`, `datetime`, `rel_type`, `leadid`, `clientid`, `contacts`, `tags`, `assigned`, `visit_planner_company_name`, `visit_planner_to`, `visit_planner_gstno`, `visit_planner_address`, `visit_planner_city`, `visit_planner_state`, `visit_planner_country`, `visit_planner_zip`, `visit_planner_email`, `visit_planner_phone`) VALUES
(1, 'Test', 'Planned Visit', '2024-12-07 11:19:00', 'Customer', 0, 3, '1', '', 1, 'GAURAJ INFOTECH PRIVATE LIMITED', 'Nihar Soni', '', '804 K10 Grand Atlantis, Sarabhai Campus, Genda Circle', 'Vadodara', 'Gujarat', 102, '390007', 'n.r.soni1@gmail.com', '09722104104');
