...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (staff_can('view',  'visit_planner') || staff_can('view_own',  'visit_planner')) {
        $CI->app_menu->add_sidebar_menu_item('visit_planner', [
            'name'     => _l('visit_planner'),
            'href'     => admin_url('visit_planner'),
