...
$table_data = [
    [
        'name'     => '<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" name="mass_select_all" data-to-table="expenses"><label></label></div>',
        'th_attrs' => ['class' => $withBulkActions === true && $hasPermission ? '' : 'not_visible'],
    ],
    _l('the_number_sign'),
    _l('expense_category'),
    _l('expense_total_amount'),
    _l('expense_employee'),
    _l('expense_type'),
